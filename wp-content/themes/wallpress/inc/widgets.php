...
class wallpress_recent_flickr_Widget extends WP_Widget {
	...
	function wallpress_recent_flickr_Widget() {
		$widget_ops = array( 'classname' => 'wallpress-photo', 'description' => __('Photo gallery widget','wallpress') );
		$this->WP_Widget( 'wallpress-photo', __('Photo gallery widget','wallpress'), $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$instance = wp_parse_args( (array) $instance, array( 
				'title' => htmlentities(__('<span class="title-blue">flick</span><span class="title-red">r</span> widget','wallpress')), 
				'column' => 2, 
				'row' => 2 ) 
		);
		extract($instance);
	...
	function form( $instance ) {
		...
		?> 
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Widget titlte ( with html )', 'wallpress') ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('row'); ?>"><?php  _e('Widget row','wallpress'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Widget Category','wallpress') ?></label>
